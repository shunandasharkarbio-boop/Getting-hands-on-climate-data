...
In order to answer this question, I am going to inspect and visualize the dataset tg_ens_mean_0.1deg_reg_v20.0e_Paris_daily.csv using simple galaxy tools.

Hands On: Daily temperature time series
--
Question:
